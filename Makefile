...
# besu.bevel.io/bevel-operator-besu-bundle:$VERSION and besu.bevel.io/bevel-operator-besu-catalog:$VERSION.
IMAGE_TAG_BASE ?= ghcr.io/sownak/bevel-operator-besu
